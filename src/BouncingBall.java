...
public class BouncingBall extends JFrame implements MouseListener {
    ...
    public static void main(String[] args) throws IOException {
        ...
        graphics.setColor(Color.blue);
          ...
          background = ImageIO.read(BouncingBall.class.getClassLoader().getResource("images/background 1"));
        ...
        imgB = ImageIO.read(BouncingBall.class.getClassLoader().getResource("images/reprize.png"));
        ...
        while (true) {
            ...
            if (yCord[3] == -150)
                xCord[3] =  60+ disc.nextInt(700);

           if (prizeY == 0)
                prizeX = 30 + disc.nextInt(700);
